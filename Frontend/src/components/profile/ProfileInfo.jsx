    ...
    <div>
      <div className="text-gray-700">
        <div className="grid md:grid-cols-2 gap-2">
          <div className="grid grid-cols-2  border-blue-800">
        ...
        <div className="flex justify-end items-center mt-6">
          <Link
            ...
            className="inline-flex font-bold text-xs sm:text-sm bg-indigo-800 text-white hover:bg-white px-2 sm:px-3 py-2 hover:text-blue-800 border hover:border-blue-800 items-center rounded
