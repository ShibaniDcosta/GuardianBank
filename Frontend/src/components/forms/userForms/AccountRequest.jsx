...
export const AccountRequest = () => {
  ...
  return (
    <div className="max-w-5xl w-full">
      <h3 className="flex justify-center items-center text-xl text-center font-bold px-2 py-4 mb-10  border-blue-800 ">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex justify-center items-center font-semibold flex-wrap gap-4 mb-5 p-2">
          <label
            className="basis-full sm:basis-[50%] text-md  my-2 sm:my-0  p-2 border-blue-800"
        ...
        <PaymentMethods title="Add Initial Balance Using a Credit Card" />
