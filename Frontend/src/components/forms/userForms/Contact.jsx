...
export const Contact = () => {
  return (
    <div className="max-w-4xl w-full">
      <h3 className="flex justify-center items-center text-2xl sm:text-3xl mb-10 p-4 text-center font-bold bg-indigo-100 text-gray-900  border-blue-800 rounded shadow">
