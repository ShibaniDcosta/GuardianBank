...
export const RegisterAdmin = () => {
  ...
  return (
    <div className="max-w-5xl w-full">
      <h3 className="flex items-center justify-center text-2xl text-center font-bold px-2 py-4 mb-10 rounded shadow bg-indigo-100  border-blue-800 text-gray-900">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/*form button */}
        <FormButton
          text={{ loading: "Processing", default: "Add Employee" }}
          isLoading={isLoading}
