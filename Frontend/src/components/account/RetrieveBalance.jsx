  ...
  if (intialBalance)
    return (
      <div className="max-w-5xl w-full">
        <h3 className="flex justify-center items-center text-xl  sm:text-2xl text-center font-bold px-2 py-4 mb-10 bg-indigo-100  border-blue-800 rounded shadow ">
          <FcDebt className="mr-1" size={50} />
          Retrieve Your Balance
        </h3>
        <form onSubmit={handleSubmit}>
          <p className="text-base  text-center font-semibold !font-sans px-2 py-4 mb-10 bg-indigo-100  border-blue-800 rounded shadow ">
