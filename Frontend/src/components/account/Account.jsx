...
export const Account = () => {
  ...
  if (
    ...
    (!isUserAccountLoading || !isUserDataLoading) && info?.role !== 'merchant'
  )
    return <NoAccountYet/>
  ...
  if (account && !isUserAccountLoading && !isUserDataLoading)
    return (
      <div className="max-w-5xl w-full">
        <h3 className="flex justify-center items-center text-3xl my-5 px-6 py-3 text-center font-bold text-blue-900  border-blue-800">
          <span>Dashboard</span>
        </h3>
