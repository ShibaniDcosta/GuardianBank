...
export const SideNavbar = ({ admin = null, user = null }) => {
  ...
  return (
    <>
      ...
      <div className="w-180 absolute sm:relative bg-[#ffffff] shadow-lg flex-col justify-between hidden lg:flex ">
        <div className="h-screen overflow-y-auto px-8 py-8 sticky top-0 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-blue-400">
          ...
          {/* Welcome Message */}
          <div className="flex items-center p-2 my-4 bg-indigo-100 text-sm font-bold text-blue-800  border-blue-800 rounded shadow">
      ...
      {/*Mobile Sidebar */}
      <div
        className="w-180 h-screen z-40 fixed bg-slate-50 shadow-lg md:h-full flex-col justify-between lg:hidden  transition-all duration-300  ease-in-out -translate-x-full"
        id="mobile-nav"
      >
        <div
