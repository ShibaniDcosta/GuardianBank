...
export const PaginationTable = ({
  ...
  return (
    <div className="overflow-x-auto relative shadow-md sm:rounded-lg my-10  border-red-800 rounded scrollbar-thin scrollbar-track-transparent scrollbar-thumb-blue-400">
      {isLoading && (
