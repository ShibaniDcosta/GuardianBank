...
export const UsersListControl = ({ usersList }) => {
  ...
  return (
    <div className="max-w-5xl w-full">
      <h3 className="text-2xl my-10 p-3 text-center font-bold bg-indigo-100 text-gray-900">
        Users
      </h3>
      ...
      {!searchQuery && filteredUsers.length === 0 && !isLoading && (
        <div className="bg-yellow-200 text-gray-800 text-center font-bold my-4 py-4 px-2">
